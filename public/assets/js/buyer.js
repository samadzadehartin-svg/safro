...
function referenceHeroSection() {
  ...
  return `<section class="hero-v8 reference-hero" aria-labelledby="heroTitle">
    <div class="reference-hero-glow reference-hero-glow-a"></div>
    <div class="reference-hero-glow reference-hero-glow-b"></div>
    <div class="hero-v8-copy reference-hero-copy">
      <span class="hero-v8-kicker"><i class="fa-solid fa-sparkles"></i> SAFARO · سفر، دقیق‌تر از همیشه</span>
      <h1 id="heroTitle">سفرت را <span>متفاوت</span><br>تجربه کن.</h1>
      <p>تور، هتل، ویزا و ظرفیت واقعی را یک‌جا ببین. سفرو انتخاب را ساده می‌کند تا تو فقط به تجربه‌ی سفر فکر کنی.</p>
      <form class="hero-search-v8 reference-search" aria-label="جستجوی تور" onsubmit="applyHeroSearch(event)">
        ...
        <label class="hero-search-item">
          <span><i class="fa-regular fa-user"></i> مسافر</span>
        ...
        <button class="hero-search-submit" type="submit"><span>پیدا کن</span><i class="fa-solid fa-arrow-left"></i></button>
      </form>
      <div class="hero-trust-v8 reference-trust" aria-label="مزیت‌های سفرو">
        ...
        <span class="hero-v8-meta"><b>${faNum(activeTours.length)}</b> تور فعال</span>
      </div>
    </div>
    <div class="reference-hero-cards" aria-hidden="true">
      <article class="reference-mini-card reference-mini-card-a">
        <span class="reference-mini-icon"><i class="fa-solid fa-wand-magic-sparkles"></i></span>
        <div><b>تور خودتو بساز</b><small>تاریخ، هتل و بودجه دلخواه</small></div>
        <i class="fa-solid fa-arrow-left reference-mini-arrow"></i>
      </article>
      <article class="reference-mini-card reference-mini-card-b">
        <span class="reference-mini-icon"><i class="fa-solid fa-compass"></i></span>
        <div><b>انتخاب بدون سردرگمی</b><small>همه‌چیز شفاف، یک‌جا</small></div>
        <i class="fa-solid fa-arrow-left reference-mini-arrow"></i>
      </article>
    </div>
  </section>`;
...
function renderHome() {
  ...
  $('app').innerHTML = `${referenceHeroSection()}
    ...
    ${filtersSection(list)}
    ${categoryBarHtml()}
    <div id="tours" class="tour-list-head-v49 row"><div><span class="badge domestic">انتخاب و رزرو</span><h2>تورهای آماده سفر</h2><p class="small">قیمت اتاق، ظرفیت و هتل‌ها را شفاف مقایسه کن.</p></div><div class="row" role="status" aria-live="polite"><b id="tourCount">۰</b><span class="tour-count-label">تور پیدا شد</span></div></div>
