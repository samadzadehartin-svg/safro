...
function minHotel(t){return (t.hotels||[{price:t.price}]).slice().sort((a,b)=>a.price-b.price)[0]}
function totalCapacity(t){return (t.hotels||[]).reduce((s,h)=>s+Number(h.capacity||0),0)}
