...
function openForm(id){
  ...
  ['title','dest','duration','airline','returnAirline','flightTime','returnFlightTime','flightNumber','price','img','dates','gallery','desc','itinerary','docs','includes','excludes','cancel','child','oldPrice','newPrice','dealPercent','dealEndsAtFa'].forEach(x=>{if($(x))$(x).value=''});
  if(t){
