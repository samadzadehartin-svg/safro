...
function openForm(id){
  const t=id?findTour(id):null;$('modal').classList.add('on');setTimeout(()=>{$('modal')?.scrollTo({top:0,behavior:'smooth'});},30);$('formTitle').textContent=t?'ویرایش تور':'افزودن تور';$('tid').value=t?.id||'';
